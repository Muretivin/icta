  ...
  <body>
            ...
            <nav>
              <ul class="metismenu" id="menu">
                <li class="active">
                  ...
                  >
                  <ul class="collapse">
                    <li class="active"><a href="index.html">MEMOS</a></li>
                    <li><a href="index2.html">INBOX</a></li>
                    <li><a href="index3.html">SENT</a></li>
                  </ul>
                </li>
                <li>
                  <a href="javascript:void(0)" aria-expanded="true"
                    ><i class="ti-layout-sidebar-left"></i
                    ><span>READ MEMOS</span></a
                  >
                  <ul class="collapse">
                    <li><a href="index.html">APPROVED</a></li>
                    <li>
                      <a href="index3-horizontalmenu.html">REJECTED</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="javascript:void(0)" aria-expanded="true"
                    ><i class="ti-pie-chart"></i><span>STARRED</span></a
                  >
                  <ul class="collapse">
                    <li><a href="barchart.html"></a></li>
                    <li><a href="linechart.html"></a></li>
                    <li><a href="piechart.html"></a></li>
                  </ul>
                </li>
                <li>
                  <a href="javascript:void(0)" aria-expanded="true"
                    ><i class="ti-palette"></i><span>SCHEDULED</span></a
                  >
                </li>
              </ul>
            </nav>
    ...
    <section class="memo">
     <form id="form" method="post" action="">
         <h2> SEND A MEMO TO ANY DEPARTMENT</h2>
